        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentInfosId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bills_PaymentInfos_PaymentInfosId",
                        column: x => x.PaymentInfosId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShoppingCartItem_Bills_BillId",
                        column: x => x.BillId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "admin123*", "seller", "admin" });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Password", "Role", "Username" },
                values: new object[] { 2, "test", "buyer", "clientTest" });

            migrationBuilder.CreateIndex(
                name: "IX_Bills_PaymentInfosId",
                table: "Bills",
                column: "PaymentInfosId");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingCartItem_BillId",
